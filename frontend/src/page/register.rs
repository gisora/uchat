...
use dioxus::prelude::*;
use crate::{elements::keyed_notification_box::{KeyedNotificationBox, KeyedNotifications}, prelude::*};
...
#[inline_props]
pub fn UsernameInput<'a>(cx: Scope, state: UseState<String>, oninput: EventHandler<'a, FormEvent>,) -> Element<'a> {
    cx.render(rsx! {
        div {
            class: "flex flex-col",
            label {
